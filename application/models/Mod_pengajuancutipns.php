...
class Mod_pengajuancutipns extends CI_Model {
    ...
    function getAll()
    {
        ...
        return $this->db->order_by('id_pns','desc')->get('tbl_pengajuan_pns');
    }

    function getdataAll()
    {
        $cuti_pns = $this->db->get('tbl_pengajuan_pns')->result();
        return $cuti_pns;
    }
    ...
    // function get_namapengajuancutipns($nama){
    //     $this->db->from($this->table);
    ...
    function get_pengajuancutipns($id)
    {   
        $this->db->where('id_pns',$id);
    ...
    // function insert_aksespengajuancutipns($tbl_pengajuan_pns, $data)
    // {
    ...
    // function delete_aksespengajuancutipns($id, $tbl_pengajuan_pns){
    //     $this->db->where('id', $id);

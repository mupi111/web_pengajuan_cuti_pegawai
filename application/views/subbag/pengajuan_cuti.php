            ...
            <div class="card">
              <div class="card-header bg-light">
                ...
                <div class="text-right">
                  <a href="<?php echo base_url('pengajuancuti/download') ?>" type="button" class="btn btn-sm btn-outline-info" id="dwn_menu" target="_blank" title="Download"><i class="fas fa-download"></i> Download</a>
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="pengajuancuti" class="table table-bordered table-striped table-hover">
                  <thead>
                    <tr class="bg-info">
                      <th>NIP/NRP</th>
                      <th>Nama</th>
                      ...
                      <th>Tgl Akhir</th>
                      <th>Sisa Cuti</th>
                      <th hidden>Alamat Selama Cuti</th>
    ...
    <div class="modal fade" id="modal-default">
      <div class="modal-dialog">
        <div class="modal-content" >
          <div class="modal-header">
            <h4 class="modal-title ">View Pengajuan Cuti</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
...
$(document).ready(function() {
 ...
 table =$("#pengajuancuti").DataTable({
  "responsive": true,
  "autoWidth": false,
  "language": {
    "sEmptyTable": "Data Pengajuan Cuti Belum Ada"
  },
        ...
        "ajax": {
          "url": "<?php echo site_url('pengajuancuti/ajax_list')?>",
          "type": "POST"
        },
         ...
         { 
            ...
            "render": function ( data, type, row ) {
               ...
               return "<a class=\"btn btn-xs btn-outline-info\" href=\"javascript:void(0)\" title=\"View\" onclick=\"vmenu("+row[13]+")\"><i class=\"fas fa-eye\"></i></a> <a class=\"btn btn-xs btn-outline-primary\" href=\"javascript:void(0)\" title=\"Edit\" onclick=\"edit_menu("+row[5]+")\"><i class=\"fas fa-edit\"></i></a>";
            },
...
//view
function vpengajuancuti(id){
  $('.modal-title').text('View Pengajuan Cuti');
  $("#modal-default").modal('show');
  $.ajax({
    url : '<?php echo base_url('pengajuancuti/view_pengajuancuti'); ?>',
    type : 'post',
    data : 'table=tbl_pengajuan_cuti&id='+id,
...
//   }
  ...
  function save()
  {
    ...
    var url = "<?php echo site_url('pengajuancuti/update')?>";

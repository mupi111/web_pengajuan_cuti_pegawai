...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-header bg-info">
      <h5><i class="fas fa-sign-in-alt"></i> Log in to start your session</h5>
    </div>
    <div class="card-body login-card-body">
      ...
      <form action="" role="form" id="quickForm" method="post">
        ...
        <div class="input-group mb-3 kosong">
          ...
          <!-- /.col -->
          <div class="center" >
            <button type="button" id="login" class="btn btn-info btn-block btn-flat"><span class="fa fa-sign-in-alt"></span> Log In</button>
          </div>
          <!-- /.col -->
        <!-- </div> -->
      </form>

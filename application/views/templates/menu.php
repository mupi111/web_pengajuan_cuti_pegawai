...
<!-- Navbar -->
  ...
  <html>
  <head>
    <!-- <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/jqClock.css" />
    <script src="<?php echo base_url();?>assets/jquery.js"></script>
    <script src="<?php echo base_url();?>assets/jqClock.min.js"></script>
      ...
      foreach ($main_menu->result() as $main) {
        ...
        ?>
          <li class="nav-item has-treeview <?=$this->uri->segment(1) == $link ? 'menu-open' : '' ?>">
            ...
            <a href="<?=$main->link;?>" <?=$this->uri->segment(4) == $link ? 'class="nav-link active"' : 'class="nav-link"' ?> >
          ...
          <?php }else{ ?>
          <li class="nav-item">
            <a href="<?=$main->link;?>" <?=$this->uri->segment(3) == $main->link ? 'class="nav-link active"' : 'class="nav-link"' ?>>
...
<!-- <script src="https://cdn.datatables.net/buttons/2.2.3/js/buttons.colVis.min.js"></script> -->
    ...
    <!-- <script>
      $(document).ready(function() {
        var table = $('table table-bordered table-striped table-hover').DataTable( {
            lengthChange: false,
            buttons: [ 'copy','excel']
        } );

      table.buttons().container()
        .appendTo('table table-bordered table-striped table-hover .col-md-6:eq(0)');
      });
    </script> -->
  </body>
</html>

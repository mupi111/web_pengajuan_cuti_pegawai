            ...
            <div class="card">
              <div class="card-header bg-light">
                ...
                <div class="text-right">
                  ...
                  <!-- <a href="<?php echo base_url('pengajuancutipelaksana/download') ?>" type="button" class="btn btn-sm btn-outline-info" id="dwn_menu" target="_blank" title="Download"><i class="fas fa-download"></i> Download</a> -->
                  ...
                  <a href="<?php echo base_url('pengajuancutipelaksana/pdf') ?>" type="button" class="btn btn-sm btn-outline-info" id="dwn_menu" target="_blank" title="Print"><i class="fas fa-download"></i> Print</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="pengajuancuti_pelaksana" class="table table-bordered table-striped table-hover">
                  <thead>
                    <tr class="bg-info">
                      <th>NIP/NRP</th>
                      <th>Nama</th>
    ...
    <div class="modal fade" id="modal-default">
      <div class="modal-dialog">
        <div class="modal-content" >
          <div class="modal-header">
            <h4 class="modal-title ">View Pengajuan Cuti Pelaksana</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
...
$(document).ready(function() {
 ...
 table =$("#pengajuancuti_pelaksana").DataTable({
  "responsive": true,
  "autoWidth": false,
  "language": {
    "sEmptyTable": "Data Pengajuan Cuti Pelaksana Belum Ada"
  },
        ...
        "ajax": {
          "url": "<?php echo site_url('pengajuancutipelaksana/ajax_list')?>",
          "type": "POST"
        },
         ...
         { 
            ...
            "render": function ( data, type, row ) {
               ...
               return "<a class=\"btn btn-xs btn-outline-info\" href=\"javascript:void(0)\" title=\"View\" onclick=\"view("+row[14]+")\"><i class=\"fas fa-eye\"></i></a> <a class=\"btn btn-xs btn-outline-primary\" href=\"javascript:void(0)\" title=\"Edit\" onclick=\"edit("+row[14]+")\"><i class=\"fas fa-edit\"></i></a>";
            },
...
//view
function view(id){
  $('.modal-title').text('View Pengajuan Cuti pelaksana');
  $("#modal-default").modal('show');
  $.ajax({
    url : '<?php echo base_url('pengajuancutipelaksana/view'); ?>',
    type : 'post',
...
//     if (result.value) {
//       $.ajax({
//         url:"<?php echo site_url('pengajuancutipelaksana/delete');?>",
//         type:"POST",
//         data:"id_pengajuancutipelaksana="+id,
//         cache:false,
//         dataType: 'json',
...
function add()
{
  ...
  function edit(id){
   save_method = 'update';
    ...
    $.ajax({
      url : "<?php echo site_url('pengajuancutipelaksana/edit') ?>/" + id,
      type: "GET",
      dataType: "JSON",
  ...
  function save()
  {
    ...
    if (save_method == 'add') {
      url = "<?php echo site_url('pengajuancutipelaksana/insert') ?>";
    } else {
      url = "<?php echo site_url('pengajuancutipelaksana/update') ?>";
    }
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="card-body">
            ...
            <!-- <div class="form-group row ">
              ...
              <div class="col-sm-9 kosong">
                <input type="text" class="form-control" name="status" id="status" placeholder="Status Tidak Perlu Diisi">
              </div>
            </div> -->
          </div>
        </form>
